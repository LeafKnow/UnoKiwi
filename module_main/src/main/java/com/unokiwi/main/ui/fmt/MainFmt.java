package com.unokiwi.main.ui.fmt;
...
import com.unokiwi.main.R;
import com.unokiwi.main.R2;
...
public class MainFmt extends ActionFmt {
    ...
    private ActionFmt[] mFragments = new ActionFmt[2];
...
//            mFragments[SECOND] = getFragment(Constants.SHOPPING_CART_FMT);
            mFragments[SECOND] = getFragment(Constants.MINE_FMT);
